...
#include "OmniaPenetrationAvoidanceFeeler.generated.h"

/**
 * Struct defining a feeler ray used for camera penetration avoidance.
 */
USTRUCT()
struct FOmniaPenetrationAvoidanceFeeler
{
	GENERATED_BODY()
	...
	FOmniaPenetrationAvoidanceFeeler()
	...
	FOmniaPenetrationAvoidanceFeeler(const FRotator& InAdjustmentRot,
